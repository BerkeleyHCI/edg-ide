...
case class DseDerivedStatic(path: DesignPath, var value: DsePathParameterSearch) extends DseDerivedConfig
    with Serializable {
...
class DseSearchGeneratorTest extends AnyFlatSpec with Matchers {
  ...
  it should "generate a static config space" in {
    val config1 = DsePathParameterSearch(DesignPath() + "param1", Seq(0, 1).map(IntValue(_)))
    val config2 = DsePathParameterSearch(DesignPath() + "param2", Seq(10, 11, 12).map(IntValue(_)))

    val partial12 = PartialCompile(params =
      Seq(
        DesignPath() + "param1",
        DesignPath() + "param2",
      )
    )
    val partial2 = PartialCompile(params =
      Seq(
        DesignPath() + "param2",
      )
    )
    ...
    generator.nextPoint() should equal(Some(
      Some(rootCompiler),
      partial2,
    ...
    generator.nextPoint() should equal(Some(
      ...
      Refinements(instanceValues =
        Map(DesignPath() + "param1" -> IntValue(0), DesignPath() + "param2" -> IntValue(10))
      ),
    ...
    generator.nextPoint() should equal(Some(
      ...
      Refinements(instanceValues =
        Map(DesignPath() + "param1" -> IntValue(0), DesignPath() + "param2" -> IntValue(11))
      ),
    ...
    generator.nextPoint() should equal(Some(
      ...
      Refinements(instanceValues =
        Map(DesignPath() + "param1" -> IntValue(0), DesignPath() + "param2" -> IntValue(12))
      ),
    ...
    generator.nextPoint() should equal(Some(
      ...
      Refinements(instanceValues =
        Map(DesignPath() + "param1" -> IntValue(1), DesignPath() + "param2" -> IntValue(10))
      ),
      Refinements(instanceValues = Map(DesignPath() + "param2" -> IntValue(10))),
      3.0f / 6
    ))
    ...
    generator.nextPoint() should equal(Some(
      ...
      Refinements(instanceValues =
        Map(DesignPath() + "param1" -> IntValue(1), DesignPath() + "param2" -> IntValue(11))
      ),
      Refinements(instanceValues = Map(DesignPath() + "param2" -> IntValue(11))),
      4.0f / 6
    ))
    ...
    generator.nextPoint() should equal(Some(
      ...
      Refinements(instanceValues =
        Map(DesignPath() + "param1" -> IntValue(1), DesignPath() + "param2" -> IntValue(12))
      ),
      Refinements(instanceValues = Map(DesignPath() + "param2" -> IntValue(12))),
      5.0f / 6
    ))
  ...
  it should "generate a derived config space" in {
    ...
    val containedConfig1 = DsePathParameterSearch(DesignPath() + "param1", Seq(0, 1).map(IntValue(_)))
    val derivedConfig1 = DseDerivedStatic(DesignPath() + "param1", containedConfig1)
    val containedConfig2 = DsePathParameterSearch(DesignPath() + "param2", Seq(10).map(IntValue(_)))
    ...
    generator.nextPoint() should equal(Some(
      None,
      partialEmpty, // first is the generating compile
      SeqMap(),
      Refinements(),
      Refinements(),
      0.0
  ...
  it should "generate a hybrid derived config space" in {
    ...
    generator.nextPoint() should equal(Some(
      None,
      partial12, // first is root compile pre-config1
      SeqMap(),
      Refinements(),
      Refinements(),
      0.0
    ...
    generator.nextPoint() should equal(Some(
      Some(rootCompiler),
      partialEmpty, // generating compile
      SeqMap(config1 -> IntValue(0)),
      Refinements(instanceValues = Map(DesignPath() + "param1" -> IntValue(0))),
      Refinements(instanceValues = Map(DesignPath() + "param1" -> IntValue(0))),
      0.0
    ...
    val containedConfig2new = DsePathParameterSearch(DesignPath() + "param2", Seq(11).map(IntValue(_)))
